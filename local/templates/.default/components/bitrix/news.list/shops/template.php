...
<?
    //собираем координаты в единый массив
    $arrCoords = array();
    $i = 0;
...
<script>
    ...
    $(document).ready(function () {
        ...
        function initialize() {
            ...
            //имитация клика по метке на карте при клике на город в списке под картой
            $(".shopContainer").click(function(){
                ...
                $("html, body").animate({ scrollTop: 400}, 500 , function(){
                    ...
                    map.setCenter({lat:parseFloat(coordsVar[0]),lng:parseFloat(coordsVar[1])});  //центровка карты
                    activateMarker({lat:parseFloat(coordsVar[0]),lng:parseFloat(coordsVar[1])},thisMarker, map); //обновление метки
                });

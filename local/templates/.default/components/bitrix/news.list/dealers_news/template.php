...
<div class="col2">
    <h3>Последние новости дилерам</h3>
    ...
    <?foreach($arResult["ITEMS"] as $arItem):?>
        ...
        <div class="catalog_wrapper__item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
            ...
            <a href="<?=$src?>" target="_blank" class="catalog_wrapper__item__image">
                <div class="arrow_white"><img src="/img/arrow<?=$i?>.png" alt=""></div>
            ...
            <div class="catalog_wrapper__item__info">
                ...
                <span class="item_info__description"><?=$arItem["PREVIEW_TEXT"]?></span>
                <span class="item_info__date"><?=$arItem["DISPLAY_ACTIVE_FROM"]?></span>
            </div>

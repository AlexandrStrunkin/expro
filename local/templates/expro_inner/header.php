    ...
    <div class="catalog_top">
        ...
        <div class="catalog_filter">
            ...
            <?if ($APPLICATION->GetCurDir() != "/catalog/") {?>
                ...
                <?$APPLICATION->ShowViewContent('catalogFilter'); // контент находитс€ в шаблоне списка разделов /bitrix/catalog/exproCatalog/bitrix/catalog.section.list/.default/template.php а также в шаблонах компонента bitrix:catalog.section - table и blocks?>
            ...
            <?/*
                ...
                <option value="все ценовые категории">¬се ценовые категории</option>
                <option value="от дешевых к дорогим">ќт дешевых к дорогим</option>
                <option value="от дорогих к дешевым">ќт дорогих к дешевым</option>
                </select>
                </div>
            */?>
...
<div class="info-block-bg " style="border-top: 1px solid #e1e0de;">

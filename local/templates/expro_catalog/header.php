    ...
    <div class="catalog_top">
        ...
        <div class="catalog_filter">
            ...
            <?if ($APPLICATION->GetCurDir() != "/catalog/") {?>
                ...
                <?$APPLICATION->ShowViewContent('catalogFilter'); // контент находится в шаблоне списка разделов /bitrix/catalog/exproCatalog/bitrix/catalog.section.list/.default/template.php и в шаблоне blocks компонента bitrix:catalog.section?>
